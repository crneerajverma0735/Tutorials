<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<head>
		...
		<body>
			...
			<p>
			<a href="/First/admissionForm.html?siteTheme=green">Green</a> | 
			<a href="/First/admissionForm.html?siteTheme=red">Red</a>
			</p>
			
			<a href="/First/admissionForm.html?siteLanguage=en">English</a>
			
			<a href="/First/admissionForm.html?siteLanguage=fr">French</a>
			<h1>${headerMessage}</h1>
