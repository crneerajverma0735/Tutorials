...
public class VectorTestDemo {
	public static void main(String args[]) {
		// Example of a vector for string
		...
		// Iterating through the String Vector using iterator - Insertion order is
		// maintained
		...
		// *********************** Example of a vector for integer
		...
		//**********************************Example of a vector for User Defined Type like Country
